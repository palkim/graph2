...
namespace fst
{
    ...
    public:
        ...
        float computeDiffuse_without_kd(const math::Vector3f& wi, const math::Vector3f& wo, const math::Vector3f& normal) const;
        math::Vector3f computeSpecular(const math::Vector3f& wi, const math::Vector3f& wo, const math::Vector3f& normal) const;
